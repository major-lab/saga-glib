public abstract class Saga.Task<T> : Saga.Monitorable, Saga.Object, GLib.Object
{
	...
	public virtual void cancel_async (double timeout = 0.0, int priority = GLib.Priority.DEFAULT)
	...
	public virtual T get_result_async (int priority = GLib.Priority.DEFAULT)   throws Error.NOT_IMPLEMENTED,
	                                                                                  Error.INCORRECT_URL,
	                                                                                  Error.BAD_PARAMETER,
	                                                                                  Error.ALREADY_EXISTS,
	                                                                                  Error.DOES_NOT_EXIST,
