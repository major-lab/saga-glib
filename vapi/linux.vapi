...
namespace Linux {
	...
	public const int RLIMIT_AS;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_CORE;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_CPU;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_DATA;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_FSIZE;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_LOCKS;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_MEMLOCK;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_MSGQUEUE;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_NICE;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_NOFILE;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_NPROC;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_RSS;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_RTPRIO;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_RTTIME;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_SIGPENDING;
	[CCode (cheader_filename = "sys/resource.h")]
	public const int RLIMIT_STACK;

	[CCode (has_type_id = false, cheader_filename = "sys/resource.h")]
	public struct rlim_t : int64 {}

	[CCode (cheader_filename = "sys/resource.h")]
	public const rlim_t RLIM_INFINITY;

	[CCode (cname = "struct rlimit", has_type_id = false, cheader_filename = "sys/resource.h")]
	...
	[CCode (cheader_filename = "sys/resource.h")]
	public int prlimit (Posix.pid_t pid, int resource, RLimit new_limit, out RLimit old_limit);
}
